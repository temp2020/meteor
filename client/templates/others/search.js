...
function SearchCtrl (
  ...
  $ionicPopover.fromTemplateUrl('client/templates/nav-links/search.html', {
    scope: $scope
  ...
  this.getListings = function(){
    ...
    this.subscribe('listingIndex', () => [ 'search', undefined, self.options ], {
      onReady: function() {
        ...
        self.call('allPosts', 'search', undefined, self.options, function(err, count) {
          self.allposts = count;
